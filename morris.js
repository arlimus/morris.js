...
(function() {
          ...
          _results.push((function() {
            ...
            for (sidx = _k = 0, _len1 = _ref2.length; _k < _len1; sidx = ++_k) {
              ...
              if (ypos !== null) {
                ...
                if (!this.options.horizontal) {
                  lastTop += size;
                  _results1.push(this.drawBar(left, top, barWidth, size, this.colorFor(row, sidx, 'bar'), this.options.barOpacity, this.options.barRadius));
                } else {
                  lastTop -= size;
  ...
  Morris.Donut = (function(_super) {
    ...
    Donut.prototype.select = function(idx) {
      ...
      if (this.options.forceSelection != null) {
        idx = this.options.forceSelection;
      }
      _ref = this.segments;
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        s = _ref[_i];
